    ...
    <div className="flex flex-1 flex-col">
      ...
      <div className="mx-auto flex flex-col px-4 w-full lg:w-form-lg max-w-4xl mb-28">
        <div className="prose dark:prose-invert lg:prose-lg">
          <p>
            Welcome to Carbon Manufacturing Systems Corporation ("Carbon", "Company", 
          ...
          <p>
            THESE SERVICES ARE PROVIDED BY CARBON ON AN "AS IS" AND "AS AVAILABLE" BASIS. CARBON MAKES NO REPRESENTATIONS 
          ...
          <p>
            NEITHER CARBON NOR ANY PERSON ASSOCIATED WITH CARBON MAKES ANY WARRANTY OR REPRESENTATION WITH RESPECT TO THE 
            COMPLETENESS, SECURITY, RELIABILITY, QUALITY, ACCURACY, OR AVAILABILITY OF THE SERVICES. WITHOUT LIMITING THE 
            FOREGOING, NEITHER CARBON NOR ANYONE ASSOCIATED WITH CARBON REPRESENTS OR WARRANTS THAT THE SERVICES, THEIR 
          ...
          <p>
            CARBON HEREBY DISCLAIMS ALL WARRANTIES OF ANY KIND, WHETHER EXPRESS OR IMPLIED, STATUTORY, OR OTHERWISE, 
          ...
          <p>
            ...
            OR LOCAL LAWS, STATUTES, RULES, OR REGULATIONS, EVEN IF CARBON HAS BEEN PREVIOUSLY ADVISED OF THE POSSIBILITY 
            OF SUCH DAMAGE. EXCEPT AS PROHIBITED BY LAW, IF THERE IS LIABILITY FOUND ON THE PART OF CARBON, IT WILL BE LIMITED TO THE TOTAL FEES 
            PAID OR PAYABLE BY YOU TO CARBON UNDER THIS AGREEMENT IN THE TWELVE (12) MONTHS IMMEDIATELY PRECEDING THE EVENT GIVING 
            RISE TO THE CLAIM, AND UNDER NO CIRCUMSTANCES WILL THERE BE CONSEQUENTIAL OR PUNITIVE DAMAGES. SOME STATES DO NOT ALLOW 
            THE EXCLUSION OR LIMITATION OF PUNITIVE, INCIDENTAL OR CONSEQUENTIAL DAMAGES, SO THE PRIOR LIMITATION OR EXCLUSION MAY 
            NOT APPLY TO YOU.
          </p>
