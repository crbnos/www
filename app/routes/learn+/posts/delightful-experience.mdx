...
3. Get pricing ASAP ([instant pricing](/learn/how-to-instant-quote) is ideal)
...
- [Make it Easy to Find You](#make-it-easy-to-find-you)
- [Reduce Friction for First-time Buyers](#reduce-friction-for-first-time-buyers)
- [Provide Self-Service Options for Repeat Buyers](#provide-self-service-options-for-repeat-buyers)
- [Choose the Right Software Stack](#choose-the-right-software-stack)
...
There are many considerations that go into [selecting (or building) the right ERP/MES solution](/learn/build-vs-buy). Ideally, the Intake Form and Portal should be built on top of a system that:

- Has a robust API (REST and realtime)
- Captures custom form submissions as structured data
- [Automatically generates Bills of Material and Bills of Process](/learn/configuration-is-all-you-need) from form submissions
