...
seoTitle: "ITAR compliance for manufacturers"
publishedAt: "2026-07-26"
summary: "What an ITAR compliant ERP requires: access control, technical data handling, data residency, and why self-hosting is the strongest architecture for it."
tag: "Compliance"
author: "chase"
---
...
If ITAR, CMMC, or data residency requirements are shaping your next ERP decision, it's worth evaluating a system built to be self-hosted and inspected rather than only trusted. [Try Carbon free for 30 days](/pricing) at https://app.carbon.ms, or review the source directly on [GitHub](https://github.com/crbnos/carbon) before you commit any controlled data to it.
