...
4. **Job audits:** auditors trace specific, real production jobs through your records from start to finish, checking that every required record exists and matches.
...
6. **Nonconformance and corrective action history:** how you've handled past process escapes and whether the corrective action addressed the root cause.
