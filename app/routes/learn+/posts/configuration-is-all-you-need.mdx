...
OK, it's not _all_ you need. You also need good processes, a good API, a good data model, and a way to change things when you need to. But a configurator is super important for making a general-purpose manufacturing software work for your business-specific needs. Let's dive in.
...
A configurator is a set of functions that map the unique 20% to the standard 80%.
...
Let's take a look at a few examples. Here's a simple example of how we might "define" a door to be manufactured:
