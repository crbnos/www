...
Multiply that by every major version you cross, and by however many years you run the platform, and the "free" open-source base license starts looking different — a theme we cover in full in [Odoo TCO for manufacturers](/learn/odoo-tco-for-manufacturers).
