---
title: "Syncing Onshape with your ERP: from CAD to BOM"
...
2. The integration matches BRK-200's Onshape part ID to the ERP item BRK-200, with no manual lookup, because the mapping was established once, when the item was first created.
