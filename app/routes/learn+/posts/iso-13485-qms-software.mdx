---
title: "ISO 13485 QMS: What Medical Device Makers Need From Software"
publishedAt: "2026-07-22"
summary: "ISO 13485 software requirements explained: document control, DHR/DMR, traceability, CAPA, and risk management — and why bolt-on QMS tools fall short."
tag: "Compliance"
author: "chase"
---

ISO 13485 does not mandate a specific piece of software. What it mandates is a set of outcomes — controlled documents, a device master record and device history record for every unit, full traceability, closed-loop CAPA, and documented risk management — that are extremely hard to produce reliably from spreadsheets, shared drives, and a disconnected quality module once you're shipping real volume. Understanding iso 13485 software requirements means translating the standard's clauses into the fields, records, and workflows your production system actually needs to hold.
...
## What ISO 13485 Actually Requires From Software

ISO 13485:2016 doesn't have a chapter called "software requirements." Instead, several clauses have direct, unavoidable implications for whatever system you use to run production and quality:
...
- **Clause 7.1 / ISO 14971 — Risk management.** Risk controls identified during design have to be traceable to the production and inspection steps that actually enforce them.
...
A device master record (DMR) is the definitive specification for how a device is made — the "recipe." A device history record (DHR) is the proof that a specific unit or lot was actually made according to that recipe, including inspection results and any deviations.
...
ISO 13485 requires component-level traceability for implantable devices, not just finished-unit traceability — meaning the specific lots of raw material and purchased components used in a given unit have to be recorded and retrievable, not just the finished device's lot number.
