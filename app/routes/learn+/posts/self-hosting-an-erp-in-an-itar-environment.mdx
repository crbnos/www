...
- **Retention policy that matches your compliance obligations**, not only your storage budget. DFARS and CMMC contracts often specify minimum retention for quality and traceability records that outlasts a default 30- or 90-day backup window. See [CMMC 2.0 for small defense manufacturers](/learn/cmmc-for-small-defense-manufacturers) for how this overlaps with CMMC's own logging and retention expectations.
