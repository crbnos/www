...
>(({ className, children, size, ...props }, ref) => (
  <DialogPortal>
    <DialogOverlay>
      ...
      >
        {children}
        <DialogPrimitive.Close className="absolute right-4 top-4 rounded-none opacity-70 ring-offset-background transition-opacity hover:opacity-100 focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 disabled:pointer-events-none data-[state=open]:bg-accent data-[state=open]:text-foreground-muted p-2 hover:bg-accent/80">
          <X className="h-4 w-4" />
