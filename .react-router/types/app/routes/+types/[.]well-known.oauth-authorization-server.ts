...
type Module = typeof import("../[.]well-known.oauth-authorization-server.js")

type Info = GetInfo<{
  file: "routes/[.]well-known.oauth-authorization-server.ts",
  module: Module
}>
...
type Matches = [{
  ...
  module: typeof import("../[.]well-known.oauth-authorization-server.js");
}];
